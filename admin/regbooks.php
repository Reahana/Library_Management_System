...
<div class="row">
	...
	<div class="col-md-8">
	<center><h3 style="color:#0d6efd">Registered Books</h3></center>	
	<br>	
		<form>
		<table class="table table-striped table-primary table-bordered" width="900px" style="text-align: center">
				<tr>
					<th>Name:</th>
					<th>Author:</th>
					<th>Price:</th>
