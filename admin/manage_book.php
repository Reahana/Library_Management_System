...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #E8F6EF">
	<div class="container-fluid">
		<ul class="nav justify-content-center">
			<li class="nav-item">
				<a href="admin_dashboard.php" class="nav-link " aria-current="page">Dashboard</a>
			</li>
			<li class="nav-item dropdown">
			<a class="nav-link active dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Book</a>
				<div class="dropdown-menu">
				...
				<?php
					...
					while($row = mysqli_fetch_assoc($query_run)){
						...
						<tr>
							...
							<td>
								<button class="btn btn-warning" name=""><a style="text-decoration:none ; color:black" href="edit_book.php?bn=<?php echo $row['book_no'];?>">Edit</a></button>
								<button class="btn btn-danger" name=""><a style="text-decoration:none ; color:white" href="delete_book.php?bn=<?php echo $row['book_no'];?>">Delete</a></button>
							</td>
						</tr>
						<?php
					}
