...
<div class="row">
	...
	<div class="col-md-8">
	<center><h3 style="color:#198754">Registered Users</h3></center>	
	<br>	
	<form>
			<table class="table table-striped table-success table-bordered" width="900px" style="text-align: center">
				<tr>
					<th>Name:</th>
					<th>Email:</th>
					<th>Mobile:</th>
